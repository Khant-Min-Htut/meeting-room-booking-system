...
const options: swaggerJSDoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: "1.0.0",
      description:
        "API documentation for the Meeting Room Booking System. This API allows users to manage meeting rooms, bookings, and user accounts.",
      contact: {
        name: "API Support",
    ...
    components: {
      securitySchemes: {
        bearerAuth: {
          ...
          bearerFormat: "JWT",
          description:
            "JWT authentication token. Obtain it by logging in via /api/auth/login",
        },
      },
      schemas: {
        User: {
